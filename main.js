...
const addToCartTransaction = new load.Transaction("AOS-DevWeb-S01-02 Add To Cart");
...
const shoppingCartTransaction = new load.Transaction("AOS-DevWeb-S01-03 Shopping Cart");
...
const updateQuantityTransaction = new load.Transaction("AOS-DevWeb-S01-04 Update Quantity");
...
const removeProductTransaction = new load.Transaction("AOS-DevWeb-S01-05 Remove Product");
